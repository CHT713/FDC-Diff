...
if __name__ == '__main__':
    ...
    p.add_argument('--has_bonds', type=bool, default=False, help='True = has bonds -- False = no bonds')
    ...
    p.add_argument('--out_edge_nf', type=int, default=None, help='边特征预测的输出维度，默认为N_RDBOND_TYPES')
