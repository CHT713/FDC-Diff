...
from tqdm import tqdm
sys.path.append('../')
from analyses.anal import plot_metrics
...
supplier1 = Chem.SDMolSupplier('../data/CCD/origin_kekulized.sdf')
supplier2 = Chem.SDMolSupplier('../data/CCD/components-pub_yuel_kekulized.sdf')
...
nfails = 0
npasses = 0
for mol1, mol2 in tqdm(zip(supplier1, supplier2)):
    # calculate the metrics
    try:
...
#        print(f'Accuracy: {accuracy}, Precision: {precision}, Recall: {recall}, F1 score: {f1_score}')
    ...
    f1_scores.append(f1)
plot_metrics(accuracies, precisions, recalls, f1_scores, outfile='figures/ccd_metrics.svg')
